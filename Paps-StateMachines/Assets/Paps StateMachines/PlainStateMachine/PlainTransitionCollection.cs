...
namespace Paps.StateMachines
{
    internal class PlainTransitionCollection<TState, TTrigger> : IEnumerable<Transition<TState, TTrigger>>
    {
        ...
        public PlainTransitionCollection(IPlainStateMachine<TState, TTrigger> stateMachine, IEqualityComparer<TState> stateComparer, IEqualityComparer<TTrigger> triggerComparer,
            TransitionEqualityComparer<TState, TTrigger> transitionEqualityComparer)
        {
